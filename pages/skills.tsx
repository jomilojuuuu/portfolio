  ...
  return (
    <div>
        ...
        <motion.div 
            ...
            <h3 className='absolute top-1 uppercase tracking-[20px] text-gray-500 text-2xl text-gray-5oo '>
                Skills
            </h3>
            
            <div className='space-y-5 md:space-y-10 py-20 px-0 md:px-10 w-56 h-56 md:w-64 md:h-95 xl:w-[600px] xl:h-[400px] -mt-[150px] md:-mt-11'>
            ...
            viewport={{ once: true }}
            className='grid grid-cols-2 gap-3 md:grid-cols-2 md:gap-5 py-20 w-56 h-56 md:w-64 md:h-95 xl:w-[600px] xl:h-[400px]  md:-mt-52'>
